...
/*
	...
	char --------------->  1byte(8bits) --->  con signo: -128 a 127
	                                          sin signo(unsigned): 0 a 255
	short int (short) -->  2bytes(16bits)-->  con signo: -32768 a 32767
						  sin signo(unsigned): 0 a 65535
	int  --------------->  4bytes(32bits)-->  con signo: -2147483648 a 2147483647
						  sin signo(unsigned): 0 a 4294967295
	long int (long) ---->  8bytes(64bits)-->  con signo: -2147483648 a 2147483647
						  sin signo(unsigned): 0 a 4294967295
